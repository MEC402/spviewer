...
//TODO
void imageHandler::rotateCamera(char direction){
...
imageHandler::imageHandler(std::string d,osgViewer::Viewer *av, osgGA::CameraManipulator* _cm,osg::Group* rt, osg::Group* _root, int* _row, int* _col,AwesomiumImage *awe){
    hor=0;
    filename=d;
    ai=awe;
    zupdate=0.0f;
...
bool imageHandler::spHandle(const osgGA::GUIEventAdapter& ea){
